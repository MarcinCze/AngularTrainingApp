...
describe('ConfirmationModalComponent', () => {
  ...
  it('ok button should emit proper value', () => {
    component.isVisible = true;
    component.title = 'Test Title';
    component.message = 'Test Message';
    fixture.detectChanges();
    const spy = spyOn(component, 'onBtnClick');
    fixture.debugElement.query(By.css('button.btn-yes')).triggerEventHandler('click', null);
    fixture.detectChanges();
    expect(spy).toHaveBeenCalled();
  });

  it('cancel button should emit proper value', () => {
    component.isVisible = true;
    component.title = 'Test Title';
    component.message = 'Test Message';
    fixture.detectChanges();
    const spy = spyOn(component, 'onBtnClick');
    fixture.debugElement.query(By.css('button.btn-no')).triggerEventHandler('click', null);
    fixture.detectChanges();
    expect(spy).toHaveBeenCalled();
  });
});
