...
describe('CoursesListComponent', () => {
  ...
  const courseServiceMock: Partial<CourseService> = {
    getCourses: () => [
      { id: 1, title: 'Test Course 1', creationDate: new Date(), description: 'Test Course 1/2 Description', duration: 900 },
      { id: 2, title: 'Test Course 2', creationDate: new Date(), description: 'Test Course 2/2 Description', duration: 400 }
    ]
  };
