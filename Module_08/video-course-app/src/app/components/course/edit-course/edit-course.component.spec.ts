...
describe('EditCourseComponent - EditMode', () => {
  ...
  //   component.ngOnInit();
  //   expect(component.courseId).toEqual(referenceVideoCourse.id);
  //   expect(component.course).toEqual(referenceVideoCourse);
  //   expect(component.courseForm.value.title).toContain(referenceVideoCourse.title);
  //   expect(component.courseForm.value.description).toContain(referenceVideoCourse.description);
  // });
